      ...
      return Stack(
        children: [
          ...
          AnimatedOpacity(
            ...
            opacity: _loaderController.shouldShowLoader ? 1.0 : 0.0,
            onEnd: () {
              if (!_loaderController.shouldShowLoader) {
                _loaderController.setHideLoaderAnimationInProgress(to: false);
              }
            },
            child: _loaderController.shouldShowLoader ||
                    _loaderController.hideLoaderAnimationInProgress == true
                ? _buildLoader(context: context)
                : SizedBox.shrink(), // Removes the widget after animation
          ),
          // AnimatedOpacity(
          //     duration: Duration(milliseconds: 300),
          //     opacity: hasInternetConnection ? 0.0 : 1.0,
          //     child: _networkController.hasInternetConnection
          //         ? SizedBox.shrink()
          //         : _buildNoInternetConnection(context: context)),
        ],
      );
    });
  }
