...
import '../../../api_services/models/country_list_response.dart';
...
class ConnectVpnController extends GetxController {
  ...
  final _selectedCountry = CountryModel(
    name: "New York",
    countryCode: "ny",
    image: Assets().imageAssets.dummyCountryIcon2,
  ).obs;
  ...
  void setSelectedCountry({required int at}) {
    //selectedCountry = ;
  }
